            ...
            <div class="mx-auto w-full">
                ...
                <div class="mb-6 text-center">
                    ...
                    <p class="mt-1 text-xs leading-5 text-gray-500 dark:text-gray-400">
                        Lengkapi data diri untuk membuat akun petugas.
                    </p>
                </div>
                ...
                <div class="mt-6">
                    <form method="POST" action="{{ route('register') }}" class="space-y-4">
                        ...
                        <!-- Name Input -->
                        <div>
                            <label class="block text-xs font-medium leading-5 text-gray-900 dark:text-gray-200" for="name">
                                Nama Lengkap
                            </label>
                            <div class="mt-1 relative rounded-lg shadow-sm">
                                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                    <span class="material-symbols-outlined text-gray-400 text-[18px]">badge</span>
                                </div>
                        ...
                        <div>
                            <label class="block text-xs font-medium leading-5 text-gray-900 dark:text-gray-200" for="password_confirmation">
                                Konfirmasi Password
                            </label>
                            <div class="mt-1 relative rounded-lg shadow-sm">
                                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                        ...
                        <div class="flex items-center justify-between pt-1">
                            <a class="text-xs font-semibold text-primary hover:text-primary/80 transition-colors" href="{{ route('login') }}">
                                Sudah punya akun?
                            </a>
                        </div>
