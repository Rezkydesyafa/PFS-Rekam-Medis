    ...
    <div class="w-full max-w-4xl mx-auto">
        <nav class="flex mb-6 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-2">
                ...
                <li><span class="text-slate-400 mx-2">›</span></li>
                <li class="text-slate-300 font-medium">Tambah Obat</li>
            </ol>
        </nav>

        <div class="mb-8">
            <h1 class="text-3xl font-bold text-white mb-2">Tambah Data Obat</h1>
            <p class="text-slate-400">Masukkan informasi lengkap obat baru.</p>
        </div>

        <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl shadow-xl overflow-hidden">
            <form method="POST" action="{{ route('obat.store') }}" class="p-8">
                @csrf
