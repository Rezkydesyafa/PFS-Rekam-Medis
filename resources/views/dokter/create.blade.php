<x-app-layout>
    <div class="mx-auto max-w-4xl flex flex-col gap-6">
        <div class="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
            ...
            <span class="material-symbols-outlined text-xs">chevron_right</span>
            <span class="font-medium text-slate-900 dark:text-white">Tambah Dokter</span>
        </div>

        <div class="flex flex-col gap-1">
            <h1 class="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Tambah Dokter Baru</h1>
            <p class="text-slate-500 dark:text-slate-400">Masukkan informasi dokter baru dengan data yang valid.</p>
        </div>
